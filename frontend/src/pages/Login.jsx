...
const Login = () => {
  ...
  // 1. Email болон Password-оор нэвтрэх
  const handleEmailLogin = async (e) => {
    e.preventDefault();
    setError('');
    try {
      await signInWithEmailAndPassword(auth, email, password);
      // Амжилттай нэвтэрвэл Dashboard (/) руу шилжинэ
      navigate('/'); 
    } catch (err) {
      console.error(err);
  ...
  return (
    <div style={containerStyle}>
      <div style={loginCardStyle}>
        ...
        {/* Алдааны мэдээлэл харуулах хэсэг */}
        ...
        <div style={socialContainerStyle}>
          {/* Facebook Button (Одоогоор зөвхөн дизайн) */}
...
const containerStyle = {
  ...
  alignItems: 'center',
  background: '#A5C0FF', // Чиний сонгосон цэнхэр өнгө
  minHeight: '100vh',
  padding: '20px'
};
...
const loginBtnStyle = {
  ...
  marginTop: '10px',
  transition: '0.3s',
  boxShadow: '0 10px 20px rgba(0,53,160,0.2)'
};
